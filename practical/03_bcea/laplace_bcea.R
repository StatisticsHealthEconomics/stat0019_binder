...
#' Running the model using JAGS and R2jags
library(R2jags)
...
#' NB: This is often *NOT* good practice as it may overwrite existing 
#'     variables in the workspace!
attach.jags(model)

###############################################################################
#' You can also use BUGS and R2OpenBUGS (assuming you have installed that too)...
...
ceplane.plot(he,wtp=10000, graph="gg")
eib.plot(he, plot.cri=FALSE, graph="gg")
contour(he, graph="gg")